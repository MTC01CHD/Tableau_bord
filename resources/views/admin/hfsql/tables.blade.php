                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Table HFSQL</th>
                            <th>Colonne date pour filtre incrémental</th>
                    ...
                    <tbody>
                        @foreach ($remote as $name)
                            ...
                            <tr class="row" data-name="{{ strtolower($name) }}">
                                ...
                                <td><input type="text" name="date_columns[{{ $name }}]" value="{{ $l->date_column ?? '' }}" placeholder="ex: Modification_date"
                                           style="width:200px;padding:3px 6px;border-radius:4px;border:1px solid var(--border);background:var(--bg);color:var(--text);font-size:12px;font-family:monospace;"></td>
